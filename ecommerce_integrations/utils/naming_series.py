...
def get_series():
	return {
		...
		"credit_note_series": frappe.get_meta("Sales Invoice").get_options("naming_series"),
		"delivery_note_return_series": frappe.get_meta("Delivery Note").get_options("naming_series"),
	}
